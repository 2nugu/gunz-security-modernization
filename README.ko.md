...
**문서 진입점: [`delivery/ko/README.md`](./delivery/ko/README.md)** (영어판: [`delivery/README.md`](./delivery/README.md))

## 구성

| 경로 | 내용 |
|------|------|
| `delivery/` | 전달 문서 패키지 영어판 (브리프, 모듈 명세 13종, 통합 가이드, 운영 런북, 검증 키트, 라이선스 인벤토리) |
| `delivery/ko/` | 한국어 원문, 동일한 파일 구조 |
| `BGM/` | 신규 BGM 트랙 (mp3) |
| `Wallpapers/` | 배경화면 이미지 |
| `rankmark/` | 랭크 마크 이미지 |
...
의존성 라이선스 검토는 [`delivery/ko/03-license-inventory.md`](./delivery/ko/03-license-inventory.md) 를 참고하세요.
